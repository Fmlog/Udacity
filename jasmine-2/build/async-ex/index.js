 ...
 */
var URLink = "https://restcountries.com/v2";
/** Create getCountry Function here */
function getCountry(country) {
    return __awaiter(this, void 0, void 0, function () {
        var getApi, countryObj, countryProps;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("".concat(URLink, "/name/").concat(country))];
                case 1:
                    getApi = _a.sent();
                    countryObj = getApi.data[0];
                    countryProps = {
                        capital: countryObj.capital,
                        region: countryObj.region,
                        numericCode: countryObj.numericCode
                    };
                    return [2 /*return*/, countryProps];
            }
        });
    });
}
...
function getRegionCountries(regionalbloc) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("".concat(URLink, "/regionalbloc/").concat(regionalbloc))];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data;
                    countries = [];
