import _ from "../utilities/arrays.js";
...
describe("Tests for `cut3` function", function () {
  ...
  it("expects to return given array - 3rd element", function () {
    expect(_.cut3(arr1)).toEqual(arr4);
  });
});
